package co.legu.requirements.api.role.services;

import java.util.List;

import co.legu.requirements.api.role.bo.MenuBo;
import co.legu.requirements.api.role.bo.RoleBo;
import co.legu.requirements.api.role.bo.RoleMenuBo;
